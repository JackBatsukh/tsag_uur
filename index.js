...
//       var starOpacity =
//         progress < 0.2 ? 1 - progress / 0.2 : (progress - 0.8) / 0.2;
...
//       var moonOpacity =
//         progress < 0.1 ? 1 - progress / 0.1 : (progress - 0.9) / 0.1;
...
//       canvas.height +
//       sunRadius -
//       Math.sin(progress * Math.PI) * (canvas.height - sunPeakY + sunRadius);
//     ctx.beginPath();
//     ctx.arc(canvas.width / 2, sunY, sunRadius, 0, 2 * Math.PI);
//     ctx.fill();
//     // Ground
//     var groundGradient = ctx.createLinearGradient(
//       0,
//       canvas.height - 50,
//       0,
//       canvas.height
